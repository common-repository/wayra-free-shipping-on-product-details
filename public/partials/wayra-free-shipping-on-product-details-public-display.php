 ...
 * @subpackage Wayra_Free_Shipping_On_Product_Details/public/partials
 */
?>
<div class="wayra-fsop-info">
    ...
    <?php } ?>
    <div class="wayra-fsop-text"><?php echo $text ?>
        <?php if ( ! empty( $subtitle ) ) { ?>
        <div class="wayra-fsop-subtitle"><?php echo $subtitle ?></div>
        <?php } ?>
    </div>
</div>